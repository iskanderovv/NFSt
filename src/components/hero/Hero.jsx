...
const Hero = () => {
  return (
    <div className="container max-w-[1200px] mx-auto px-3 gap-2 grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 items-center lg:mb-60 md:mb-30 sm:mb-16 mb-10">
      <div>
